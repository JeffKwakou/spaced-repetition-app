...
exports.add = async (req, res) => {
    try {
        const { front, back, info_sup } = req.body;
        const user = req.user;
...
exports.update = async (req, res) => {
    try {        
        ...
        const flashcardUpdated = await Flashcard.updateOne({_id: req.params.flashcardid,userId: user._id}, { $set: {front: req.body.front,back: req.body.back, info_sup: req.body.info_sup}})
